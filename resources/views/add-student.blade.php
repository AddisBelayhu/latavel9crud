    ...
    <div class="container" style="margin-top:60px">
        <div class="row">
            <div class="col-md-12">
              ...
              @endif
              <form  method="post" action="{{url('save-student')}}" style="width:80%; background-color:#edf1f5;
               box-shadow: 5px 10px 18px #888888; border-radius:5px">
                ...
                <div class="md-3" style="margin-left:2%">
                    ...
                    autocomplete="off" style="width:70%">{{old('address')}}</textarea>
                    @error('address')
                    <div class="alert alert-danger" role="alert">
                     {{$message}}
                   </div>
                ...
                <br><br>
                <button type="submit" class="btn btn-primary" style="width:80px; margin-left:2%">Submit</button> &nbsp;&nbsp;
